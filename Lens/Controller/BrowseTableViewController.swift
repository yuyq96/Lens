...
class BrowseTableViewController: UITableViewController, IndicatorInfoProvider {
    ...
    override func viewDidLoad() {
        ...
        switch type {
        case Context.type.equipment:
            switch info {
            case Context.info.lens:
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        switch type {
        case Context.type.equipment, Context.type.libraries, Context.type.wishlist:
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch type {
        case Context.type.equipment, Context.type.libraries, Context.type.wishlist:
            let productDetailTableViewController = ProductDetailTableViewController()
